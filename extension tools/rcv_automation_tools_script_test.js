//var titleVersion = (1 == 1 ? 'Fix AT [release_23.1.30]: ' : 'Fix AT [vi10][release_23.1.30]: ')
...
///////////////////////////////////////////_________GET INFO IN BEATS__________////////////////////////////////////
    ...
    if(url.indexOf('beats.int.ringcentral.com/failure') != -1) {
        ...
        try { // statements to try
            ...
            if ((finaleTitleCase.split(",").length - 1) > 6) finaleTitleCase = ''
            ...
            window.alert('Beats report is generated correctly !')
    ...
    if(url.indexOf('beats.int.ringcentral.com/testList') != -1) {
        ...
        try {
            ...
            window.alert('Beats case list copied successfully !')
...
///////////////////////////////////////////_________GET JIRA TICKETS RCV CASES__________////////////////////////////////////
    ...
    if(url.indexOf('jira.ringcentral.com/browse/RCV-') != -1) {
        ...
        try {
            ...
            window.alert('Jira rcv tickets were copied correctly !')
...
///////////////////////////////////////////_________GET TEST IT STEPS__________////////////////////////////////////
    ...
    if(url.indexOf('testit.ringcentral.com/test-cases/') != -1) {
        ...
        try {
            ...
            window.alert('TestIt steps copied successfully !')
    ...
    if (url.indexOf('jira.ringcentral.com/secure/') != -1) {
        ...
        try {
            ...
            */
            ...
            alert('Jira ticket generate correctly!')
        ...
        /** 
        * Uncomment for auto create task
        */
        if (autoCreate) {
